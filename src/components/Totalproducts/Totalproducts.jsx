    ...
    <React.Fragment>
      {/* <div className="total_products">
        ...
        <div className="total_carts">
          <h4>
            1/4 High Cartbon Stainless Steel Terminal  Crimping Tools
            Crimper Tools
          </h4>
          ...
          <div className="availbea">
            <h5>Immediately available, delivery time: 1-3 days</h5>
          </div>
          <h5>Leitungslänge</h5>
          <div className="meter">
          ...
          <div className="total_carts_buttons">
            <div className="bu">1</div>
            <div className="total_but">
              <p className="total_but_p">In den Warenkorb</p>
            </div>
          </div>
